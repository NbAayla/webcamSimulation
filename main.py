...
while True:
    for file in args.input_files:
        ...
        while inputVideo.isOpened():
            ...
            # framerate of the fake "webcam" should get more accurate to the source file the longer it plays for. This
            # array is cleared to prevent any excess memory use or time spent calculating the average and because
            # different files may require different amounts of time to process their frames depending on factors such
            # as codec, resolution, pixel format, etc.
